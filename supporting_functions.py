...
def create_output_images(Rover):
      ...
      line_space = 15
      line1 = 10
      line2 = line1 + line_space
      line3 = line2 + line_space
      line4 = line3 + line_space
      line5 = line4 + line_space
      line6 = line5 + line_space
      cv2.putText(map_add,"Mode: "+Rover.mode, (0,line1), 
                  cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)
      cv2.putText(map_add,"Time: "+str(np.round(Rover.total_time, 1))+' s', (0, line2), 
                  cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)
      cv2.putText(map_add,"Mapped: "+str(perc_mapped)+'%', (0, line3), 
                  cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)
      cv2.putText(map_add,"Fidelity: "+str(fidelity)+'%', (0, line4), 
                  cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)
     # cv2.putText(map_add,"Rocks", (0, line5), 
     #             cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)
      cv2.putText(map_add,"  Located: "+str(samples_located), (0, line5), 
                  cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)
      cv2.putText(map_add,"  Collected: "+str(Rover.samples_collected), (0, line6), 
                  cv2.FONT_HERSHEY_COMPLEX, 0.4, (255, 255, 255), 1)
