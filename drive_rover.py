...
class RoverState():
    def __init__(self):
        ...
        #self.stop_forward = 50 # Threshold of how many navagable pixels are required before initiating stopping
        self.stop_forward = 30 # minimum distance
        self.go_forward = 300 # Threshold of how many navagable pixels are required before deciding to go forward again
        ...
        self.rock_pos = [] # To store the found rock positions
        self.rock_angles = None
        self.rock_dists = None

    def new_rock_pos(self, pos):
        if pos not in self.rock_pos:
            print()
            print('self.rock_pos', self.rock_pos)
            print('pos:',pos)
            self.rock_pos.append(pos)
